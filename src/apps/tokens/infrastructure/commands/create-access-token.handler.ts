...
import { AccessTokenServiceInterface, ClientServiceInterface } from 'apps/tokens/domain/services';
import { AccessTokenCreatedEvent } from 'apps/tokens/infrastructure/events';
import { CreateAccessTokenCommand } from 'apps/tokens/infrastructure/commands';
import { ClientEntity, AccessTokenEntity } from 'apps/tokens/infrastructure/entities';
